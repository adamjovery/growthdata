...
replace country = "North Yemen" if country=="Yemen (North Yemen)"
replace country = "Congo DR" if country=="DR Congo (Zaire)"
replace country = "Cambodia" if country=="Cambodia (Kampuchea)"
replace country = "Russia" if country=="Russia (Soviet Union)"
replace country = "Yugoslavia" if country=="Serbia (Yugoslavia)"
...
replace cowcode= 402 if country=="Cabo Verde"
...
replace cowcode= 490 if country== "DR of the Congo"
replace cowcode= 490 if country== "DR Congo"
replace cowcode= 490 if country== "D.R. of the Congo"
...
replace cowcode= 490 if country== "Dem. Rep. of the Congo"
replace cowcode= 490 if country== "Congo Kinshasa"
replace cowcode= 484 if country== "Republic of the Congo"
...
replace cowcode= 437 if country=="CÃ´te d'Ivoire"
...
replace cowcode= 630 if country=="Islamic Rep. of Iran"
...
replace cowcode= 731 if country=="Dem. People's Rep. of Korea"
replace cowcode= 731 if country=="Korea, Dem. People's Rep."
...
replace cowcode= 732 if country=="Rep. of Korea"
...
replace cowcode= 812 if country==" Lao People's DR"
replace cowcode= 812 if country=="Lao People's Democratic Republic"
replace cowcode= 812 if country=="Lao People's Dem. Rep."
...
replace cowcode= 343 if country=="Macedonia, the Former Yugoslav Republic of"
replace cowcode= 343 if country=="The former Yugoslav Rep. of Macedonia"
replace cowcode= 343 if country=="North Macedonia"
replace cowcode= 343 if country=="TFYR of Macedonia"
...
replace cowcode= 359 if country=="Rep. of Moldova"
...
replace cowcode= 403 if country=="São Tomé and Príncipe"
...
replace cowcode= 365 if country=="Union of Soviet Socialist Republics"
...
replace cowcode= 625 if country=="Sudan (Former)"
replace cowcode= 115 if country=="Suriname"
replace cowcode= 572 if country=="Swaziland"
replace cowcode= 572 if country=="Eswatini"
...
replace cowcode= 510 if country=="United Rep. of Tanzania"
replace cowcode= 510 if country=="U.R. of Tanzania: Mainland"
replace cowcode= 510 if country=="Tanganyika"
replace cowcode= 800 if country=="Thailand"
replace cowcode= 711 if country=="Tibet"
replace cowcode= 711 if country=="Tibetans"
...
replace cowcode = 640 if country=="Turkiye"
...
replace cowcode= 101 if country=="Venezuela (Bolivarian Republic of)"
replace cowcode= 101 if country=="Venezuela (Bolivarian Rep. of)"
...
replace cowcode= 680 if country=="Democratic Yemen"
replace cowcode= 680 if country=="South Yemen"
replace cowcode= 678 if country=="Yemen (AR)"
replace cowcode= 678 if country=="Yemen, (AR)"
replace cowcode= 678 if country=="Yemen Arab Rep."
...
replace cowcode= 345 if country=="Serbia (and Kosovo: S/RES/1244 (1999))"
...
replace cowcode= 997 if country=="China, Hong Kong SAR"
replace cowcode= 997 if country=="Hong Kong SAR, China"
replace cowcode= 997 if country=="Hong Kong, SAR"
replace cowcode= 997 if country=="Hong Kong"
replace cowcode= 997 if country=="China, Hong Kong Special Administrative Region"
replace cowcode= 996 if country=="China, Macao SAR"
replace cowcode= 996 if country=="Macao SAR, China"
replace cowcode= 996 if country=="Macau, SAR"
replace cowcode= 996 if country=="Macao"
replace cowcode= 998 if country=="Palestine/West Bank"
replace cowcode= 998 if country=="State of Palestine"
replace cowcode= 998 if country=="Palestine"
replace cowcode= 998 if country=="West Bank and Gaza"
replace cowcode= 731 if country=="Korea, Dem. People's Rep."
replace cowcode= 101 if country=="Venezuela (Bolivarian Rep. of)"
replace cowcode= 987 if country=="Micronesia, Fed. Sts."
replace cowcode = 640 if country=="Türkiye"
replace cowcode= 31 if country=="The Bahamas"
replace cowcode= 101 if country=="R. B. de Venezuela"
replace cowcode= 678 if country=="Republic of Yemen"
replace cowcode= 630 if country=="Islamic Republic of Iran"
replace cowcode= 731 if country=="D. P. R. of Korea"
replace cowcode= 731 if country=="Democratic People's Republic of Korea"
replace cowcode= 651 if country=="Arab Republic of Egypt"
replace cowcode= 437 if country=="Côte d'Ivoire"
replace cowcode= 345 if country=="Serbia Montenegro"
replace cowcode= 987 if country=="Micronesia (country)"